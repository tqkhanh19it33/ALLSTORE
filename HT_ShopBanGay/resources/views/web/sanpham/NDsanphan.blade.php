                    ...
                    <div class="prod-info">
                        <p class="" style="width: auto; font-size: 20px;">
                                ...
                                @if($return && $SPs->money_sale > 0)
                                    <b  class="item_current_price">{{$SPs->money_sale}} đ - <strike style="color: red;">{{$SPs->money}} đ</strike></b>
                                <?php $return = false ?>
                                @endif
                                @if($return)
                                    <b class="item_current_price">{{$SPs->money}} đ</b>
                                @endif
                        </p>
                        <p class="prod-qnt">
                ...
                <div class="prod-tab-cont">
                    ...
                    <div class="prod-tab" id="prod-tab-3">
                        <ul class="reviews-list">
                            ...
                            <li class="reviews-i existimg">
                                ...
                                <div class="reviews-i-cont">
                                    <p>Numquam aliquam maiores ratione dolores ducimus,</p>
                        ...
                        <div class="prod-comment-form">
                            ...
                            <form method="POST" action="/trangchu/sanpham/binhluan/{{$SPs->id}}">
                                <input type="hidden" name="idKHCMT" value="{{Auth::user()->id}}">
                                ...
                                <div class="prod-comment-submit">
                                    ...
                                    <input type="hidden" name="DGiaSao" id="DGiaSao">

...
Route::prefix('trangchu')->group(function () {
    ...
    Route::prefix('sanpham')->group(function () {
        Route::get('thuvien', [sanphamController::class, 'sanphamthuvien']);
        Route::post('thuvien', [sanphamController::class, 'BL_sanphamthuvien']);

        Route::prefix('thuvien')->group(function () {
            Route::get('Nam', [sanphamController::class, 'sanphamthuvien_nam']);
            Route::post('Nam', [sanphamController::class, 'BL_sanphamthuvien_nam']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('Nu', [sanphamController::class, 'sanphamthuvien_nu']);
            Route::post('Nu', [sanphamController::class, 'BL_sanphamthuvien_nu']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('Tre_em', [sanphamController::class, 'sanphamthuvien_treem']);
            Route::post('Tre_em', [sanphamController::class, 'BL_sanphamthuvien_treem']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('1_3_nu', [sanphamController::class, 'sanphamthuvien_1_3_nu']);
            Route::post('1_3_nu', [sanphamController::class, 'BL_sanphamthuvien_1_3_nu']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('1_3_nam', [sanphamController::class, 'sanphamthuvien_1_3_nam']);
            Route::post('1_3_nam', [sanphamController::class, 'BL_sanphamthuvien_1_3_nam']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('3_6_nu', [sanphamController::class, 'sanphamthuvien_3_6_nu']);
            Route::post('3_6_nu', [sanphamController::class, 'BL_sanphamthuvien_3_6_nu']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('3_6_nam', [sanphamController::class, 'sanphamthuvien_3_6_nam']);
            Route::post('3_6_nam', [sanphamController::class, 'BL_sanphamthuvien_3_6_nam']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('6_12_nu', [sanphamController::class, 'sanphamthuvien_6_12_nu']);
            Route::post('6_12_nu', [sanphamController::class, 'BL_sanphamthuvien_6_12_nu']);
        });
        Route::prefix('thuvien')->group(function () {
            Route::get('6_12_nam', [sanphamController::class, 'sanphamthuvien_6_12_nam']);
            Route::post('6_12_nam', [sanphamController::class, 'BL_sanphamthuvien_6_12_nam']);
        });
    });

    Route::prefix('sanpham')->group(function () {
        Route::get('danhsach', [sanphamController::class, 'sanphamdanhsach']);
        Route::post('danhsach', [sanphamController::class, 'BL_sanphamdanhsach']);

        Route::prefix('danhsach')->group(function () {
            Route::get('Nam', [sanphamController::class, 'sanphamdanhsach_nam']);
            Route::post('Nam', [sanphamController::class, 'BL_sanphamdanhsach_nam']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('Nu', [sanphamController::class, 'sanphamdanhsach_nu']);
            Route::post('Nu', [sanphamController::class, 'BL_sanphamdanhsach_nu']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('Tre_em', [sanphamController::class, 'sanphamdanhsach_treem']);
            Route::post('Tre_em', [sanphamController::class, 'BL_sanphamdanhsach_treem']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('1_3_nu', [sanphamController::class, 'sanphamdanhsach_1_3_nu']);
            Route::post('1_3_nu', [sanphamController::class, 'BL_sanphamdanhsach_1_3_nu']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('1_3_nam', [sanphamController::class, 'sanphamdanhsach_1_3_nam']);
            Route::post('1_3_nam', [sanphamController::class, 'BL_sanphamdanhsach_1_3_nam']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('3_6_nu', [sanphamController::class, 'sanphamdanhsach_3_6_nu']);
            Route::post('3_6_nu', [sanphamController::class, 'BL_sanphamdanhsach_3_6_nu']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('3_6_nam', [sanphamController::class, 'sanphamdanhsach_3_6_nam']);
            Route::post('3_6_nam', [sanphamController::class, 'BL_sanphamdanhsach_3_6_nam']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('6_12_nu', [sanphamController::class, 'sanphamdanhsach_6_12_nu']);
            Route::post('6_12_nu', [sanphamController::class, 'BL_sanphamdanhsach_6_12_nu']);
        });
        Route::prefix('danhsach')->group(function () {
            Route::get('6_12_nam', [sanphamController::class, 'sanphamdanhsach_6_12_nam']);
            Route::post('6_12_nam', [sanphamController::class, 'BL_sanphamdanhsach_6_12_nam']);
        });
    });

    Route::prefix('sanpham')->group(function () {
        Route::get('bang', [sanphamController::class, 'sanphambang']);
        Route::post('bang', [sanphamController::class, 'BL_sanphambang']);

        Route::get('giam_gia', [sanphamController::class, 'giam_gia']);


        Route::prefix('bang')->group(function () {
            Route::get('Nam', [sanphamController::class, 'sanphambang_nam']);
            Route::post('Nam', [sanphamController::class, 'BL_sanphambang_nam']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('Nu', [sanphamController::class, 'sanphambang_nu']);
            Route::post('Nu', [sanphamController::class, 'BL_sanphambang_nu']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('Tre_em', [sanphamController::class, 'sanphambang_treem']);
            Route::post('Tre_em', [sanphamController::class, 'BL_sanphambang_treem']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('1_3_nu', [sanphamController::class, 'sanphambang_1_3_nu']);
            Route::post('1_3_nu', [sanphamController::class, 'BL_sanphambang_1_3_nu']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('1_3_nam', [sanphamController::class, 'sanphambang_1_3_nam']);
            Route::post('1_3_nam', [sanphamController::class, 'BL_sanphambang_1_3_nam']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('3_6_nu', [sanphamController::class, 'sanphambang_3_6_nu']);
            Route::post('3_6_nu', [sanphamController::class, 'BL_sanphambang_3_6_nu']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('3_6_nam', [sanphamController::class, 'sanphambang_3_6_nam']);
            Route::post('3_6_nam', [sanphamController::class, 'BL_sanphambang_3_6_nam']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('6_12_nu', [sanphamController::class, 'sanphambang_6_12_nu']);
            Route::post('6_12_nu', [sanphamController::class, 'BL_sanphambang_6_12_nu']);
        });
        Route::prefix('bang')->group(function () {
            Route::get('6_12_nam', [sanphamController::class, 'sanphambang_6_12_nam']);
            Route::post('6_12_nam', [sanphamController::class, 'BL_sanphambang_6_12_nam']);
        });
    });
...
Route::middleware(['auth'])->group(function () {
    Route::prefix('trangchu')->group(function () {
        ...
        Route::prefix('sanpham')->group(function () {
            ...
            Route::post('binhluan/{idSP}', [sanphamController::class, 'binhluan']);
